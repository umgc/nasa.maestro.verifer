...
describe('EvaHtmlProcedureWriter', function() {
	...
	describe('FULL-HTML-IMAGE', function() {
		...
		it(`should create expected screenshot of webpage for ${procedure.filename}.html`, function() {
			const expectedImg = fs.readFileSync(expectedPath).toString();
			const testImg = fs.readFileSync(testPath).toString();
			...
			try {
				...
				assert.strictEqual(testImg, expectedImg);
