...
// FIXME this was taken from HtmlTimelineWriter, and just doesn't do Nunjucks render (instead)
// just returns opts. Refactor.
/**
...
function getActivity(writer, columnIndex, task, actor) {
	...
	opts.marginTop = 0;
	opts.uuid = task.uuid; // FIXME this was added to this React version but is not in HTML version
	...
	if (task.actorRolesDict[actor].prevTask) {
		...
		opts.minutesGap = minutesGap; // FIXME this was added to React version but not in HTML
...
// FIXME this is stolen from HtmlTimelineWriter. Refactor.
/**
...
module.exports = class ReactTimelineWriter extends TimelineWriter {

	// NOTE: Could extend constructor to modify base options

	/**
	 * Generate the timeline for React
	 *
	 * @return {Object} HTML of timeline
	 */
	create() {
